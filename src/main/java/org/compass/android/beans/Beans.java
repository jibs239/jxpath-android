...
import org.compass.android.beans.beancontext.BeanContext;
...
public class Beans {
     ...
     *
     * @param isGuiAvailable should be <code>true</code> to signify that a GUI is
     *                       available, <code>false</code> otherwise.
     * @throws SecurityException if the caller does not have the required permission to access
     ...
     * environment.
     *
     * @param isDesignTime true to indicate that it's in application construction
     *                     environment.
     * @throws SecurityException
     */
